...
export class AttacksDisplay extends LitElement implements Controller {
  ...
  private renderIncomingAttacks() {
    ...
    return this.incomingAttacks.map(
      (attack) => html`
        <div
          class="flex items-center gap-0.5 w-full bg-[#101a22]/95 backdrop-blur-sm sm:rounded-md px-1.5 py-0.5 overflow-hidden ring-1 ring-[#d95b45]/25"
        >
          ${this.renderButton({
            ...
            className:
              "text-left text-[#d95b45] inline-flex items-center gap-0.5 lg:gap-1 min-w-0",
            translate: false,
          })}
          ${!attack.retreating
            ? this.renderButton({
                ...
                className:
                  "ml-auto inline-flex items-center justify-center cursor-pointer bg-[#6f251c]/55 hover:bg-[#8c3024]/70 sm:rounded-md px-1.5 py-1 border border-[#d95b45]/45",
                translate: false,
              })
            : ""}
        </div>
  ...
  private renderOutgoingAttacks() {
    ...
    return this.outgoingAttacks.map(
      (attack) => html`
        <div
          class="flex items-center gap-0.5 w-full bg-[#101a22]/95 backdrop-blur-sm sm:rounded-md px-1.5 py-0.5 overflow-hidden ring-1 ring-[#57bfd7]/15"
        >
          ${this.renderButton({
            content: html`<span class="inline-flex items-center"
                ><img
            ...
            className:
              "text-left text-[#57bfd7] inline-flex items-center gap-0.5 lg:gap-1 min-w-0",
            translate: false,
          })}
          ${!attack.retreating
            ? this.renderButton({
            ...
            : html`<span class="ml-auto truncate text-[#57bfd7]"
        ...
        >
          ${this.renderButton({
            content: html`${this.renderBoatIcon(boat)}
              ...
              >
              <span class="text-xs ml-1 text-[#8ea8b6]"
