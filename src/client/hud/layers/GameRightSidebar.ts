...
export class GameRightSidebar extends LitElement implements Controller {
  ...
  render() {
    ...
    return html`
      <aside
        class=${`w-fit flex flex-row items-center gap-3 py-2 px-3 bg-[#101a22]/95 backdrop-blur-sm shadow-xs ring-1 ring-[#57bfd7]/20 min-[1200px]:rounded-md rounded-bl-md transition-transform duration-300 ease-out transform text-[#e8f1f2] ${
